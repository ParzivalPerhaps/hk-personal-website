...
export const ContactPage = () => {
    ...
    <div style={{display:'flex'}}>
        <div className="Island" style={{width:'40%'}}>
            ...
            <div className="IslandItem" style={{width:'70%'}}>
                <p style={{textAlign:'center', width:'100%', justifyContent:'center', margin:'auto', lineHeight:'1.5', maxWidth:'100%'}}>Email: HaydenNinja@hotmail.com<br/>Phone: 972-536-3119</p>
            </div>
