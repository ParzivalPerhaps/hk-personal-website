...
export const HSharpPage = () => {
    const { unityProvider } = useUnityContext({
      ...
      return (<div className="Island" style={{height:'700px', width:'70%'}}>
            <div className="IslandHeader">
                <p>H# Demo (Refresh The Page To Restart)</p>
            </div>
            <Unity style={{justifySelf:'center', alignSelf:'center', margin:'auto', position:'absolute', width:'60%', left:'20%', top:'15rem', borderRadius:'4px'}} unityProvider={unityProvider} />
        </div>)
