...
Students interested in taking ISM must complete the application and interview process to be considered for the course. Once selected, students conduct research and interviews throughout the year on their chosen topic of study in order to select a mentor and gain real-world experience. "</i></p>
        ...
        <p className='TextLight' style={{textAlign:'center', width:'70%', justifyContent:'center', margin:'auto', marginBottom:'-3rem',  lineHeight:'1.5', marginTop:'3rem'}}><i>"Why is there a quote here again?" - Hayden Karp</i></p>
        ...
        <p className='TextLight' style={{textAlign:'center', width:'70%', justifyContent:'center', margin:'auto', marginBottom:'-3rem',  lineHeight:'1.5', marginTop:'3rem'}}><i>"I'm stuck in a love triangle between C# and Java" - Hayden Karp</i></p>
        ...
        <p className='TextLight' style={{textAlign:'center', width:'70%', justifyContent:'center', margin:'auto', marginBottom:'-3rem',  lineHeight:'1.5', marginTop:'3rem'}}><i>"C is great and all, but have you heard of Rust?" - DEFINITELY NOT Hayden Karp</i></p>
